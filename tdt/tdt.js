...
exports.convertString = function(originString, type){
	...
	if(type === 'ONS_HOSTNAME')
		...
		convertedString = engine.convertSync(originString,params,levelType.BINARY);
...
exports.getServices =  function(thingname, servicetype, callback){
	...
	/*var originString = "urn:epc:id:sgtin:8800000.300025.1234567";
	var es = engine.convertSync(originString,params,levelType.ONS_HOSTNAME);
